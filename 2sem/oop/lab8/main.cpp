...
class Pstring : public String {
    ...
    { // define String
        ...
        char str[] = "some text";
        Pstring ps = Pstring(str);
        ps.display();
        
        // Pstring s1 = Pstring("This is a very long string which is probably no, certainly--going to exceed the limit set by SZ.");
        // cout << "\ns1=";
        // s1.display(); // display String

        // Pstring s2 = Pstring("This is a short string."); // define String    
